...
man = new Manufacturer();
man.name = "Electric Motors Inc.";
man.picture = "engine.png";
man.setAddress("30 Paint Fork Road, Barnardsville, NC 28709, United States");
man.location.latitude = 35.775995;
man.location.longitude = -82.457911;
man.workingConditions.employmentProtection = 6;
man.workingConditions.salery = 5;
man.workingConditions.workingHours = 7;
manufacturers.insert(man);
...
prod = new Product();
prod.name = "Engine";
prod.picture = "Mercedes-Benz/engine.png";
prod.manufacturer = manufacturers({ name: "Electric Motors Inc." }).first();
prod.addedCarbonFootprint = 100;
prod.price.productPrice = 120;
prod.price.energyCosts = 60;
prod.price.manufacturingCosts = 50;
prod.price.materialCosts = 60;
products.insert(prod);

man = new Manufacturer();
man.name = "Michelin Reifenwerke AG";
man.picture = "michelin.png";
man.setAddress("Michelinstraﬂe 4, 76185 Karlsruhe, Germany");
man.location.latitude = 49.007800;
man.location.longitude = 8.351910;
man.workingConditions.employmentProtection = 9;
...
prod = new Product();
prod.name = "Wheel";
prod.picture = "Mercedes-Benz/wheel.png";
prod.manufacturer = manufacturers({ name: "Michelin Reifenwerke AG" }).first();
prod.addedCarbonFootprint = 50;
prod.price.productPrice = 50;
prod.price.energyCosts = 10;
prod.price.manufacturingCosts = 20;
prod.price.materialCosts = 30;
products.insert(prod);

man = new Manufacturer();
man.name = "SHANGHAI DAYOU PLASTIC MOULD CO.";
man.picture = "dayou.png";
man.setAddress("XiuPuRoad 19, 200063 Shanghai, China");
man.location.latitude = 31.230416;
man.location.longitude = 121.473701;
man.workingConditions.employmentProtection = 6;
man.workingConditions.salery = 5;
man.workingConditions.workingHours = 8;
manufacturers.insert(man);
...
prod = new Product();
prod.name = "Steering Wheel";
prod.picture = "Mercedes-Benz/swheel.png";
prod.manufacturer = manufacturers({ name: "SHANGHAI DAYOU PLASTIC MOULD CO." }).first();
prod.addedCarbonFootprint = 100;
prod.price.productPrice = 600;
prod.price.energyCosts = 40;
prod.price.manufacturingCosts = 30;
prod.price.materialCosts = 80;
products.insert(prod);
...
prod.components.push(products({ name: "Steering Wheel" }).first());
prod.components.push(products({ name: "Wheel" }).first());
prod.components.push(products({ name: "Engine" }).first());
